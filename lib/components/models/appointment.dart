...
Future<Database> initializeAppointments(Database db) async{
  ...
  await db.execute('''
    ...
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-04-23', 4, 52, 'Dermatology appointment', 'Cancelled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-04-24', 5, 15, 'Neurology consultation', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-04-25', 2, 16, 'Orthopedic follow-up', 'Completed');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-04-26', 3, 17, 'Cardiology checkup', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-04-27', 4, 18, 'Dermatology consultation', 'Completed');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-04-28', 5, 19, 'Neurology examination', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-04-29', 1, 10, 'Cardiology follow-up', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-04-30', 1, 31, 'Follow-up checkup', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-01', 2, 32, 'Orthopedic consultation', 'Completed');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-02', 1, 33, 'Cardiology examination', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-03', 4, 34, 'Dermatology appointment', 'Cancelled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-04', 5, 35, 'Neurology consultation', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-05', 2, 36, 'Orthopedic follow-up', 'Completed');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-06', 3, 37, 'Cardiology checkup', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-07', 4, 38, 'Dermatology consultation', 'Completed');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-08', 5, 39, 'Neurology examination', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-09', 1, 50, 'Cardiology follow-up', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-10', 1, 51, 'Follow-up checkup', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-11', 2, 52, 'Orthopedic consultation', 'Completed');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-12', 1, 53, 'Cardiology examination', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-13', 4, 52, 'Dermatology appointment', 'Cancelled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-14', 5, 25, 'Neurology consultation', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-15', 2, 26, 'Orthopedic follow-up', 'Completed');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-16', 3, 27, 'Cardiology checkup', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-17', 4, 28, 'Dermatology consultation', 'Completed');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-18', 5, 29, 'Neurology examination', 'Scheduled');
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-19', 1, 25, 'Cardiology follow-up', 'Scheduled');
    ...
    INSERT INTO APPOINTMENT(Appointment_Date, Doctor_ID, Patient_ID, Remarks, Status) VALUES ('2024-05-29', 1, 10, 'Cardiology follow-up', 'Scheduled');
